"""
FFmpeg Command Builder & Filtergraph Generator
...
class FFmpegBuilder:
    ...
    def detect_encoder(self, hw_accel: str = "auto") -> str:
        """Determines the best video encoder to use."""
        ...
        # Auto-detect: default to libx264 for universal stability
        return "libx264"

    def resolve_quality_params(self, profile_name: Optional[str] = None) -> Dict[str, Any]:
        """
        Resolves active encoding parameters based on user config or
        adaptive hardware auto-detection.
        """
        ...
        # Allow specific manual overrides from config.yaml if explicitly specified
    ...
    def build_overlay_filter(
        ...
        the watermark logo over the video stream, scaling appropriately for low resolutions.
        """
        # Limit logo width if stream resolution is low (e.g. 240p)
    ...
    def build_relay_command(
        ...
        # Separate Audio Input if applicable
