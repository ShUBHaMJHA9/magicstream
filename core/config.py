"""
Configuration Management Module for YT_LIVE
...
class ConfigManager:
    ...
    def load(self) -> None:
        ...
        if os.path.exists(self.config_path) and yaml is not None:
            try:
                ...
                print(f"[ConfigManager] Warning: Could not parse {self.config_path}: {e}")
    ...
    def get_destination_url(self, platform_override: Optional[str] = None, stream_key_override: Optional[str] = None) -> str:
        ...
        # If the provided key is already a full RTMP/RTMPS URL
